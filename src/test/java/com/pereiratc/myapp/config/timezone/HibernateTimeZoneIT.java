package com.pereiratc.myapp.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.pereiratc.myapp.IntegrationTest;
import com.pereiratc.myapp.repository.timezone.DateTimeWrapper;
import com.pereiratc.myapp.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    void storeLocalDateTimeWithZoneIdConfigShouldBeStoredOnGMTTimeZone() {
        ...
        final String request = generateSqlRequest("local_date_time", dateTimeWrapper.getId());
        final SqlRowSet resultSet = jdbcTemplate.queryForRowSet(request);
